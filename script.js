document.addEventListener("DOMContentLoaded", function () {
  ...
  { name: "Fesulf by 100 tablets", image: "images/fesulf_100.jpg" },
    ...
    { name: "Omega 3-6-9 softgel 1000mg", image: "images/omega_3_6_9_softgel.jpg" },
    { name: "Omega 369 1000mg(medpath natural)", image: "images/omega_369_medpath.jpg" },
    { name: "Omega 3 fish oil 1000mg(healthpath natural)", image: "images/omega_3_fish_oil_healthpath.jpg" },
    { name: "Vitamin E dietary supplements (healthpath natural)", image: "images/vitamin_e_healthpath.jpg" },
    { name: "Cod liver oil with EPA/DHA softgel 1000mg", image: "images/cod_liver_oil_softgel.jpg" },
    { name: "AJ WELLNESS evening Primosa", image: "images/aj_evening_primosa.jpg" },
    { name: "Healthpath evening primosa oil", image: "images/healthpath_evening_primosa.jpg" },
    { name: "Medpath vitamin A usp 25000 iu", image: "images/medpath_vitamin_a.jpg" },
    { name: "Medpath natural ZINC 100mg", image: "images/medpath_zinc.jpg" },
    { name: "Super calcium 600mg +D3", image: "images/super_calcium_d3.jpg" },
    { name: "Vc-1000mg", image: "images/vc_1000mg.jpg" },
    { name: "Nutrify liv detox formula", image: "images/nutrify_liv_detox.jpg" },
    { name: "Nutrify multi vitamin for MEN 50+ with probiotics", image: "images/nutrify_men_50.jpg" },
    { name: "Nutrify nourish collagen beauty formula", image: "images/nutrify_collagen.jpg" },
    { name: "Nutrify multi.vitamin for women 50+ with probiotic", image: "images/nutrify_women_50.jpg" },
    { name: "Advanced skin whitening", image: "images/advanced_skin_whitening.jpg" },
    { name: "Piping rock women’s probiotic", image: "images/pipingrock_probiotic.jpg" },
    { name: "Collagen +glutathione", image: "images/collagen_glutathione.jpg" },
    { name: "Daynee hip butt enhancing gummies", image: "images/daynee_hip_butt.jpg" },
    { name: "Booster BBL gummies", image: "images/booster_bbl_gummies.jpg" },
    { name: "BBL breast curve gummies", image: "images/bbl_breast_curve.jpg" },
    { name: "Super collagen gummies", image: "images/super_collagen_gummies.jpg" },
    { name: "Skin whitening vitamins gummies", image: "images/skin_whitening_gummies.jpg" },
    { name: "Maca plus", image: "images/maca_plus.jpg" },
    { name: "C-1000 gummies (laverly)", image: "images/c1000_gummies.jpg" },
    { name: "Restore women’s probiotic gummies", image: "images/restore_probiotic.jpg" },
    { name: "Prolife vitamin c", image: "images/prolife_vitamin_c.jpg" },
    { name: "Prolife multivitamin", image: "images/prolife_multivitamin.jpg" },
    { name: "Prolife calcium", image: "images/prolife_calcium.jpg" },
    { name: "Prolife magnesium", image: "images/prolife_magnesium.jpg" },
    { name: "Nutrity vitamin c zinc", image: "images/nutrity_vitamin_c_zinc.jpg" },
    { name: "Tecotrim 960 tablets", image: "images/tecotrim_960.jpg" },
    { name: "ABF cream", image: "images/abf_cream.jpg" },
    { name: "SkG paracetamol by 96 tablets", image: "images/skg_paracetamol_96.jpg" },
    { name: "Osteo herbal inhaler", image: "images/osteo_inhaler.jpg" },
    { name: "EBU 400 tablets", image: "images/ebu_400.jpg" },
    { name: "Supermag antacid 2liter", image: "images/supermag_antacid.jpg" },
    { name: "Neofylin syrup 2liter", image: "images/neofylin_syrup.jpg" },
    { name: "Gentamicin injections 2ml", image: "images/gentamicin_injection.jpg" },
    { name: "Philomox amoxicillin injection 500mg", image: "images/philomox_injection.jpg" },
    { name: "Naza fortified procaine penicillin injection 4mega", image: "images/naza_penicillin.jpg" },
    { name: "Fexona omeprazole injection 40mg", image: "images/fexona_omeprazole.jpg" },
    { name: "JOMIA chloroquine injection 30ml", image: "images/jomia_chloroquine.jpg" },
    { name: "Diclofenac injection 3ml", image: "images/diclofenac_injection.jpg" },
    { name: "LAMETAR Artemether injection 80mg", image: "images/lametar_artemether.jpg" },
    { name: "Chlorpheniramine injection 1ml", image: "images/chlorpheniramine_injection.jpg" },
    { name: "NAZA Promethazine injection 2ml", image: "images/naza_promethazine.jpg" },
    { name: "Dexamethasona injection 1ml", image: "images/dexamethasona.jpg" },
    { name: "Quidox quinine injection 2ml", image: "images/quidox_quinine.jpg" },
    { name: "Omefam omeprazole injection 40mg", image: "images/omefam_omeprazole.jpg" },
    { name: "Philo promethazine injection 2ml", image: "images/philo_promethazine.jpg" },
    { name: "Duetem paracetamol injection 10ml", image: "images/duetem_paracetamol.jpg" },
    { name: "Grephine ceftriaxone sodium injection 1g", image: "images/grephine_ceftriaxone.jpg" },
    { name: "Hanbet oxytocin injection 1ml", image: "images/hanbet_oxytocin.jpg" },
    { name: "Plavit b-complex injection 10ml", image: "images/plavit_bcomplex.jpg" },
    { name: "Chloramphenicol injection 1g", image: "images/chloramphenicol_injection.jpg" },
    { name: "Uniflox ciprofloxacin injection 200mg", image: "images/uniflox_ciprofloxacin.jpg" },
    { name: "Unigyl metronidazole injection 500mg", image: "images/unigyl_metronidazole.jpg" },
    { name: "Longecut hydrocortisone injection 1ml", image: "images/longecut_hydrocortisone.jpg" },
    { name: "Philo Chlorpheniramine injection 1ml", image: "images/philo_chlorpheniramine.jpg" },
    { name: "Aphamoral trypsin-chymotrypsin tablet", image: "images/aphamoral.jpg" },
    { name: "Aphazole albendazole tablet 400mg", image: "images/aphazole_albendazole.jpg" },
    { name: "Omezal omeprazole capsule", image: "images/omezal_omeprazole.jpg" }
